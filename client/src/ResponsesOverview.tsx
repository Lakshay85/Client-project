    ...
    <div className="responses-overview-page">
      ...
      <div className="responses-metrics-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px', marginBottom: '28px' }}>
        <TiltCard glowColor="rgba(13, 148, 136, 0.3)">
          <div style={{ padding: '24px', background: 'radial-gradient(ellipse at 50% 0%, #1e293b 0%, #0f172a 100%)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: 'var(--radius-lg)', display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <span style={{ fontSize: '28px', fontWeight: 800, color: '#ffffff', display: 'block' }}>{forms.length}</span>
              <span style={{ fontSize: '13px', color: '#94a3b8', fontWeight: 600 }}>Total Built Forms</span>
            </div>
          </div>
        </TiltCard>
        ...
        <TiltCard glowColor="rgba(139, 92, 246, 0.3)">
          <div style={{ padding: '24px', background: 'radial-gradient(ellipse at 50% 0%, #1e293b 0%, #0f172a 100%)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: 'var(--radius-lg)', display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <span style={{ fontSize: '28px', fontWeight: 800, color: '#ffffff', display: 'block' }}>{totalResponses}</span>
              <span style={{ fontSize: '13px', color: '#94a3b8', fontWeight: 600 }}>Total Submissions</span>
            </div>
          </div>
        </TiltCard>
        ...
        <TiltCard glowColor="rgba(16, 185, 129, 0.3)">
          <div style={{ padding: '24px', background: 'radial-gradient(ellipse at 50% 0%, #1e293b 0%, #0f172a 100%)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: 'var(--radius-lg)', display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <span style={{ fontSize: '28px', fontWeight: 800, color: '#ffffff', display: 'block' }}>{activeFormsCount}</span>
              <span style={{ fontSize: '13px', color: '#94a3b8', fontWeight: 600 }}>Active Forms</span>
            </div>
          </div>
        </TiltCard>
      </div>
              ...
              return (
                <TiltCard key={form.id} maxRotateX={8} maxRotateY={10} glowColor="rgba(6, 182, 212, 0.2)">
                  <article className="built-form-response-card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%', minHeight: '280px', background: 'linear-gradient(145deg, #0e172a 0%, #070c18 100%)', borderRadius: '24px', border: '1.5px solid rgba(255, 255, 255, 0.18)', boxShadow: '0 12px 32px rgba(0, 0, 0, 0.5)', boxSizing: 'border-box' }}>
                    ...
                    <div>
                      <div className="built-form-stats" style={{ padding: '12px 0', borderTop: '1px solid rgba(255, 255, 255, 0.08)', borderBottom: '1px solid rgba(255, 255, 255, 0.08)', marginBottom: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <span className="stat-badge responses-highlight" style={{ fontSize: '13px', fontWeight: 700, color: '#22d3ee', background: 'rgba(6, 182, 212, 0.12)', border: '1px solid rgba(6, 182, 212, 0.25)', borderRadius: '8px', padding: '8px 12px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                          <Icon name="users" size={15} /> <strong>{respCount}</strong> Submissions
                        </span>
                        <span className="stat-badge" style={{ fontSize: '13px', color: '#94a3b8', background: 'rgba(15, 23, 42, 0.6)', border: '1px solid rgba(255, 255, 255, 0.12)', borderRadius: '8px', padding: '8px 12px', display: 'flex', alignItems: 'center', gap: '6px' }}>
